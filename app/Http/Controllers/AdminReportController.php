...
class AdminReportController extends Controller
{
    public function index(Request $request)
    {
        ...
        if($from){
            $totalRevenueOrdersQuery->whereDate(
                'NgayDatHang',
                '>=',
                $from
            );
        ...
        if($from){
            $completedOrdersQuery->whereDate(
                'NgayDatHang',
                '>=',
                $from
            );
