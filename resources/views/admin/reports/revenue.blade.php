    ...
    <div id="revenue" class="tab-content active">
        ...
        <div class="dashboard-grid">
            ...
            <div class="dashboard-card">
                ...
                <div class="card-value">
                    {{ number_format($averageRevenue) }}đ
                </div>
            </div>
            ...
            <div class="dashboard-card">
                ...
                <div class="card-value">
                    {{ number_format($averageOrderValue) }}đ
                </div>
            </div>
