...
<link rel="stylesheet"
href="<?php echo e(asset('css/order.css')); ?>">
...
<div class="filter-bar">
    ...
    <form method="GET" class="filter-form">
        ...
        >
            ...
            <option value="3"
                <?php echo e(request('status')==='3' ? 'selected':''); ?>>
                Hoàn thành
            </option>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table','data' => ['headers' => [
'Mã đơn',
'Ngày đặt',
'Người nhận',
'Tổng tiền',
...
<tr>
    ...
    <td><?php echo e($o->MaDonHang); ?></td>

    <td><?php echo e($o->NgayDatHang); ?></td>

    <td><?php echo e($o->TenNguoiNhan); ?></td>
...
<?php endif; ?>
        ...
        <?php elseif($o->TrangThai == 2): ?>

            <?php if (isset($component)) { $__componentOriginal2ddbc40e602c342e508ac696e52f8719 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2ddbc40e602c342e508ac696e52f8719 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.badge','data' => ['variant' => 'gold']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'gold']); ?>
                Đang giao
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal2ddbc40e602c342e508ac696e52f8719)): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\website_trangsuc\laptrinhweb_thi_website_trangsuc\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>