...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table','data' => ['headers' => ['Mã TK', 'Họ tên', 'Tên đăng nhập', 'Email', 'Trạng thái', 'Thao tác'],'striped' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['Mã TK', 'Họ tên', 'Tên đăng nhập', 'Email', 'Trạng thái', 'Thao tác']),'striped' => true]); ?>
    <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <tr>
            <td><?php echo e($user->MaTaiKhoan); ?></td>
            ...
            <td class="action-col">
                <div class="action-buttons">
                    <a href="/admin/customers/<?php echo e($user->MaTaiKhoan); ?>">
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Chi tiết <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <a href="/admin/customers/toggle/<?php echo e($user->MaTaiKhoan); ?>">
                        <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
...
<?php $component->withAttributes(['variant' => 'danger']); ?>
                            <?php echo e($user->TrangThai == 1 ? 'Khóa' : 'Mở khóa'); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\website_trangsuc\laptrinhweb_thi_website_trangsuc\resources\views/admin/users/customers.blade.php ENDPATH**/ ?>