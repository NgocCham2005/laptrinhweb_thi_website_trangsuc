...
('DH0003', '2026-05-04 22:06:43', '2026-05-04 22:06:43', 'Thanh toán khi nhận hàng', 1, 'Lê Văn Cường', '0969234567', 'Hà Nội', 'TK0003', 'VC004', 30000.00),
...
('DH0006', '2026-05-04 22:06:43', '2026-05-04 22:06:43', 'Trả trước', 1, 'Nguyễn Thị Hạnh', '0963567890', 'Hà Nội', 'TK0006', 'VC005', 30000.00),
...
('DH0009', '2026-05-04 22:06:43', '2026-05-04 22:06:43', 'Thanh toán khi nhận hàng', 1, 'Phạm Văn Minh', '0966890123', 'Hà Nội', 'TK0009', 'VC004', 30000.00),
('DH0010', '2026-05-04 22:06:43', '2026-05-04 22:06:43', 'Trả trước', 1, 'Hoàng Thị Ngọc', '0987901234', 'Hà Nội', 'TK0010', 'VC005', 30000.00);
...
('VC001', 'Giảm 50K đơn từ 300K', 'Đơn tối thiểu 300K', 50000.00, 100),
('VC002', 'Giảm 100K đơn từ 1 triệu', 'Đơn từ 1 triệu', 100000.00, 80),
('VC003', 'Giảm 200K đơn VIP', 'Chỉ áp dụng khách VIP', 200000.00, 20),
('VC004', 'Giảm 30K đơn nhỏ', 'Không áp dụng sản phẩm giảm giá', 30000.00, 127),
('VC005', 'Freeship toàn quốc', 'Áp dụng toàn quốc', 30000.00, 127),
('VC006', 'Miễn phí vận chuyển đơn từ 200K', 'Đơn tối thiểu 200K', 30000.00, 120),
('VC007', 'Giảm 20K phí vận chuyển', 'Chỉ áp dụng phí vận chuyển', 20000.00, 90),
('VC008', 'Giảm 50% phí vận chuyển', 'Giảm tối đa 40K', 40000.00, 60),
('VC009', 'Giảm 70K cuối tuần', 'Áp dụng cuối tuần', 70000.00, 70),
('VC010', 'Freeship nhanh nội thành', 'Chỉ áp dụng nội thành', 40000.00, 50);
